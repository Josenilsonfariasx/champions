...
export class ChampionPoolController {
  async addChampion(req: Request, res: Response): Promise<Response> {
    const { teamId } = req;
  ...
  async updateChampion(req: Request, res: Response): Promise<Response> {
    const { teamId } = req;
    const { championId, roleId, proficiency, notes } = req.body;
  ...
  async removeChampion(req: Request, res: Response): Promise<Response> {
    const { teamId } = req;
  ...
  async getChampionPool(req: Request, res: Response): Promise<Response> {
    const { teamId } = req;
  ...
  async getChampionPoolByRole(req: Request, res: Response): Promise<Response> {
    const { teamId } = req;
